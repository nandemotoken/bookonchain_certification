...
function very_simple_dapps(request , response){
	...
	case '/tx_sender':
		...
		response.write("<body><h1>book on chain certification transaction sender</h1><p>トランザクションを送信します。ウォレットを操作してください。</p><p>その後、ウォレットからの完了処理が出るまでお待ちください。</p><p>処理が完了したら、元ページにお戻りください。</p></body>");
